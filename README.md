...
venv/bin/python analytics/source_evidence_view.py
venv/bin/python analytics/source_backed_scarcity.py
venv/bin/python analytics/forecast_accuracy.py
venv/bin/python analytics/forecast_validation_history.py
venv/bin/python analytics/provider_reliability_live_overlay.py
venv/bin/python analytics/signal_performance_score.py
venv/bin/python analytics/signal_explainability_drilldowns.py
venv/bin/python analytics/customer_watchlists.py
...
venv/bin/python analytics/customer_ready_executive_brief.py
...
- `analytics/source_evidence_view.py`
- `analytics/source_backed_scarcity.py`
- `analytics/forecast_accuracy.py`
- `analytics/forecast_validation_history.py`
- `analytics/provider_reliability_live_overlay.py`
- `analytics/signal_performance_score.py`
- `analytics/signal_explainability_drilldowns.py`
- `analytics/customer_watchlists.py`
- `analytics/region_scarcity_heatmap.py`
- `analytics/claim_gate_matrix.py`
- `analytics/paid_data_point_provenance.py`
- `analytics/customer_ready_executive_brief.py`
