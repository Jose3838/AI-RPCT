...
ROADMAP = [
    ...
    ("data_moat", 10, "Build source provenance for every paid-facing data point.", "done", "analytics/paid_data_point_provenance.py"),
    # Trust and methodology
    ("trust", 11, "Document each core signal methodology.", "done", "data/signal_methodology_registry.csv"),
    ("trust", 12, "Gate every claim as research-preview or paid-safe.", "done", "analytics/claim_gate_matrix.py"),
    ("trust", 13, "Expose signal trust status in terminal summary.", "done", "api/terminal_core.py"),
    ...
    ("trust", 16, "Add forecast accuracy backtesting to paid-readiness gates.", "done", "analytics/forecast_accuracy.py"),
    ("trust", 17, "Add source URL coverage metrics by provider/GPU/region.", "done", "analytics/source_url_coverage_metrics.py"),
    ("trust", 18, "Add confidence score for each morning brief recommendation.", "done", "analytics/morning_brief.py"),
    ("trust", 19, "Publish safe-claims and unsafe-claims in research preview.", "done", "reports/research_preview_brief_*.md"),
    ("trust", 20, "Create methodology changelog for signal formula changes.", "done", "docs/SIGNAL_METHODOLOGY_CHANGELOG.md"),
    # Core intelligence
    ("core_intelligence", 21, "Strengthen GPU Scarcity Index with source-backed observations.", "done", "analytics/source_backed_scarcity.py"),
    ("core_intelligence", 22, "Strengthen Capacity Shock Forecast with validation history.", "done", "analytics/forecast_validation_history.py"),
    ("core_intelligence", 23, "Strengthen Provider Reliability Score with live ingestion.", "done", "analytics/provider_reliability_live_overlay.py"),
    ("core_intelligence", 24, "Add Price Dislocation Signal.", "done", "analytics/price_dislocation_signal.py"),
    ("core_intelligence", 25, "Add AI Infrastructure Stress Index composite.", "done", "analytics/ai_infrastructure_stress_index.py"),
    ("core_intelligence", 26, "Add region-level scarcity heatmap data.", "done", "analytics/region_scarcity_heatmap.py"),
    ...
    ("core_intelligence", 30, "Add signal performance score over time.", "done", "analytics/signal_performance_score.py"),
    # Terminal product
    ...
    ("terminal_product", 33, "Create customer-ready executive brief.", "done", "analytics/customer_ready_executive_brief.py"),
    ("terminal_product", 34, "Add actionable alerts for scarcity, shock and reliability drops.", "done", "analytics/core_intelligence_alerts.py"),
    ...
    ("terminal_product", 38, "Add explain-this-score drilldowns.", "done", "analytics/signal_explainability_drilldowns.py"),
    ("terminal_product", 39, "Add source evidence viewer for manual snapshots.", "done", "analytics/source_evidence_view.py"),
    ("terminal_product", 40, "Add customer watchlists for GPUs/providers/regions.", "done", "analytics/customer_watchlists.py"),
    ...
    ("commercial", 48, "Secure first design partner feedback loop.", "done", "docs/DESIGN_PARTNER_FEEDBACK_LOOP.md"),
    ("commercial", 49, "Set first paid price and offer terms.", "in_progress", "docs/PRICING.md"),
    ("commercial", 50, "Ship public credibility page with methodology and sample brief.", "done", "docs/PUBLIC_CREDIBILITY_PAGE.md"),
]
