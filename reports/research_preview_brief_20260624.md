...
## Current Status
- Preview Status: snapshot_collection_needed
- Core Readiness Phase: blocked_by_live_data
...
- Region Universe: 15
- Provenance: fallback_contaminated
...
## Next Action
Continue collecting source-labeled manual snapshots.